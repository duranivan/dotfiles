...
you should place your code here."
  ...
  ;; Keybindings
  (define-key evil-insert-state-map (kbd "C-e") 'sp-up-sexp)
  ...
  ;;   :commands (vmd-mode)
  ;;   :init
  ;;   (evil-leader/set-key "mcP" 'vmd-mode))
  ...
  ;; Theme Modifications for Monokai
  (setq-default
   ...
   '((monokai
      ...
      (org-verbatim :foreground "#b0e2ff")
      (org-code :foreground "#63b8ff")
      ;; (sp-show-pair-match-face :underline t :inherit bold)
      ;; (font-lock-builtin-face :foreground "#ff9eb8" :weight semi-bold))))
      (font-lock-builtin-face :foreground "#66D9EF"))))
